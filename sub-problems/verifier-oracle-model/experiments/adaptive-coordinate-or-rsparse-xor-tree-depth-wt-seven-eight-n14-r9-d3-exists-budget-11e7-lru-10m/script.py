#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 110_000_000, --lru-maxsize 10_000_000.

Paired with r=5 sibling: +10% exists_tree budget over 10e7/10M (PARTIAL ~957 s) at same 10M LRU.
