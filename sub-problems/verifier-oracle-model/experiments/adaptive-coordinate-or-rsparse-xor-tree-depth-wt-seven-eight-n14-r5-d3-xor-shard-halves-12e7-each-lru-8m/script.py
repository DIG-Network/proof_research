#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only, XOR menu sharded into two halves [0:1001) and [1001:2002).

12e7 exists_tree budget per half, 8M LRU each (sequential subprocesses — no parallel 10M LRU).
