#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 240_000_000, --lru-maxsize 10_000_000.

+33% exists_tree budget over 18e7/10M (session guidance: ~45 min class extrapolated).
