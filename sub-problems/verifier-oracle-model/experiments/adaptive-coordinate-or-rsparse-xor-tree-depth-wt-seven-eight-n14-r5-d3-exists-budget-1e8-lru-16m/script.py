#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 100_000_000, --lru-maxsize 16_000_000.

Scales (budget, LRU) 2× over …-r5-d3-exists-budget-5e7-lru-8m to test whether LRU
saturation at 8M blocked completion.
