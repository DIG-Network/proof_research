#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 110_000_000, --lru-maxsize 10_000_000.

+10% exists_tree budget over 10e7/10M (PARTIAL ~838 s) while keeping LRU at 10M (12M OOM on this host).
