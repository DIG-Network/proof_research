#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 75_000_000, --lru-maxsize 12_000_000.

Intermediate bracket between (5e7, 8M) PARTIAL and (1e8, 16M) host-killed run:
session-state suggested 7.5e7 / 12M for a clean PARTIAL line on constrained RAM.
