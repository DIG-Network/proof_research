...
1.2e8 exists_tree budget per half (matches full-menu 12e7 cap, split across halves);
10M LRU each. Parent: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14/script.py
