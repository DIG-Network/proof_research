#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 60_000_000, --lru-maxsize 8_000_000.

Parent: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14/script.py
+20% exists_tree budget vs 5e7 shard (same LRU) to test proximity to a root decision.
"""
