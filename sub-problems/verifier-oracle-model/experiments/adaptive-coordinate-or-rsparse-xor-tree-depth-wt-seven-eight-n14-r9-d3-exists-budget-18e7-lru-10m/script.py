#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 180_000_000, --lru-maxsize 10_000_000.

~1.5× exists_tree budget over 12e7/10M (PARTIAL ~965 s); step-change probe for dual 2002 band.
