#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 70_000_000, --lru-maxsize 8_000_000.

Mirror of …-n14-r5-d3-exists-budget-7e7-lru-8m for the dual 2002-split band (C(14,9)=C(14,5)).
