#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 240_000_000, --lru-maxsize 10_000_000.

Paired with r=9 24e7/10M; complements C(14,5)=C(14,9) for the same 2002 XOR menu.
