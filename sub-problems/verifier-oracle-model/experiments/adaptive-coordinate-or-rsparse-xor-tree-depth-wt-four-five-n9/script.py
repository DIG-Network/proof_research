#!/usr/bin/env python3
"""
n=9, popcount in {4,5} (C(9,4)+C(9,5)=252 masks).

Same DP as n=10 {5,6} sweep: coord + r-sparse XOR r=2..(n-1), unions, full n-XOR.
Threshold slice for majority t=5: wt 4 vs wt 5.
"""
