#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 100_000_000, --lru-maxsize 12_000_000.

Prior: 10e7/10M → PARTIAL ~838 s (vs 10e7/8M ~917 s). Prior 7.5e7/12M → OOM ~8 min on host.

Parent: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14/script.py
Exit 0: PASS from parent. Exit 2: PARTIAL. Exit 1: FAIL. Other: host/OOM.
"""
