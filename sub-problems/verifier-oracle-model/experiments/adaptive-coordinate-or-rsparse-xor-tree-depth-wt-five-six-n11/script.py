#!/usr/bin/env python3
"""
n=11, popcount in {5,6} (C(11,5)+C(11,6)=924 masks).

Same DP as n=12 {6,7} sweep: coord + r-sparse XOR r=2..(n-1), unions, full n-XOR.
Threshold slice for majority t=6: wt 5 vs wt 6.
"""
