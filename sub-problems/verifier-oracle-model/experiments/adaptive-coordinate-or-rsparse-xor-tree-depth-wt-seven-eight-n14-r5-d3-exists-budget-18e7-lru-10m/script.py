#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 180_000_000, --lru-maxsize 10_000_000.

Mirror of r=9 18e7/10M (INCONCLUSIVE ~1644 s full 2002 menu) for dual 2002 XOR symmetry.
