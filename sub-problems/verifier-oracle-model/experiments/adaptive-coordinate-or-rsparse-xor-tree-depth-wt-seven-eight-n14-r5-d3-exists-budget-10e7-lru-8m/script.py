#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 100_000_000, --lru-maxsize 8_000_000.

+~11% exists_tree budget over 9e7/8M (session next step after dual 2002 band PARTIAL at 9e7).
