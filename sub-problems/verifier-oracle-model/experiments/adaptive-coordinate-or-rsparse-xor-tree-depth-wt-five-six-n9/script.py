#!/usr/bin/env python3
"""
n=9, popcount in {5,6} (C(9,5)+C(9,6)=210 masks).

Same shell *weights* as (10,{5,6}) experiments but n=9. Quorum semantics differ:
for n=9, t=5, both wt=5 and wt=6 are ≥t — this is pure shell-separation toy.

coord + r-sparse XOR sweep r=2..8, unions, full n-XOR baseline.
"""
