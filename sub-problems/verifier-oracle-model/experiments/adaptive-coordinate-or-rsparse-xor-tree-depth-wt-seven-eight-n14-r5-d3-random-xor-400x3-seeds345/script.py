#!/usr/bin/env python3
"""
Three fixed-seed random 400-index XOR submenus for n=14, r=5, d=3-only (seeds 3,4,5).

Sibling: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14-r5-d3-random-xor-400x3-seeds012
