#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 120_000_000, --lru-maxsize 10_000_000.

+20% exists_tree budget over 10e7/10M (PARTIAL ~838 s); +~9% over 11e7/10M (PARTIAL ~992 s). 12M LRU OOM on this host.
