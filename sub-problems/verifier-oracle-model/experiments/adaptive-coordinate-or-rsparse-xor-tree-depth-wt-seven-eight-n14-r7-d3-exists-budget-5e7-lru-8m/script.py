#!/usr/bin/env python3
"""
n=14 {7,8}: r=7, d=3-only with --max-exists-calls 50_000_000, --lru-maxsize 8_000_000.

C(14,7)=3432 XOR partitions (between C(14,6)=3003 PASS band and C(14,5)=2002 PARTIAL band).
