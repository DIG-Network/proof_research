#!/usr/bin/env python3
"""
n=14 {7,8}: r=10, d=3-only with --max-exists-calls 50_000_000, --lru-maxsize 8_000_000.

C(14,10)=C(14,4)=1001 XOR partitions (smaller than r=5/9 at 2002 and r=6/8 at 3003).
