#!/usr/bin/env python3
"""
n=13, popcount in {6,7} (C(13,6)+C(13,7)=3432 masks).

Same DP as n=12 {6,7} sweep. Majority t=7: wt 6 vs wt 7.
"""
...
def main() -> None:
    ...
    p.add_argument(
        ...
        default=None,
        metavar="LIST",
        help='comma-separated r values for one mixed language, e.g. "2,3,4,5"',
    )
    p.add_argument(
        "--skip-baseline",
        action="store_true",
