#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 50_000_000, --lru-maxsize 8_000_000.

Same envelope as …-n14-r5-d3-exists-budget-5e7-lru-8m and …-n14-r6-d3-exists-budget-5e7-lru-8m.
C(14,9)=2002 XOR partitions (same count as r=5).
