#!/usr/bin/env python3
"""
Reproduce the 2026-04-01 thirty-minute r=5, d=3-only probe (verifier-oracle-model).

Runs the parent n=14 {7,8} script under `timeout 1800` with unbounded LRU.
...
def main() -> None:
    ...
    if p.returncode == 124:
        print(
            "INCONCLUSIVE: timeout 1800s (exit 124) — no d=3 feasibility line in budget.",
            flush=True,
        )
