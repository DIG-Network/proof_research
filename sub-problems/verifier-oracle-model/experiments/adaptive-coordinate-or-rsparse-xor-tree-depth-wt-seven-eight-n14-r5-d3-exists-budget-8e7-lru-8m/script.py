#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 80_000_000, --lru-maxsize 8_000_000.

+~14.3% exists_tree budget over 7e7/8M (session-state next lever after dual r=5,r=9 PARTIAL at 7e7).
