#!/usr/bin/env python3
"""
Three fixed-seed random 400-index XOR submenus for n=14, r=9, d=3-only.

Parent: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14/script.py
Extends r=9 seeds {0,1,2} and {6,7,8} with seeds {9,10,11}; C(14,9)=C(14,5)=2002 XOR splits.
"""
...
TOTAL_XOR_9 = 2002  # C(14,9) == C(14,5)
SAMPLE_K = 400
SEEDS = (9, 10, 11)
...
def main() -> None:
    ...
    for seed in SEEDS:
        ...
        idxs = sorted(rng.sample(range(TOTAL_XOR_9), SAMPLE_K))
