#!/usr/bin/env python3
"""
n=7, popcount in {2,3} (C(7,2)+C(7,3)=56 masks).

Same DP as n=8 {3,4} sweep: coord + r-sparse XOR r=2..(n-1), unions, full n-XOR.
Threshold slice for majority t=4: wt 2 vs wt 3.
"""
