#!/usr/bin/env python3
"""
n=14 {7,8}: r=9, d=3-only with --max-exists-calls 120_000_000, --lru-maxsize 10_000_000.

+20% exists_tree budget over 10e7/10M; +~9% over 11e7/10M (PARTIAL ~911 s). Paired with r=5 12e7/10M.
