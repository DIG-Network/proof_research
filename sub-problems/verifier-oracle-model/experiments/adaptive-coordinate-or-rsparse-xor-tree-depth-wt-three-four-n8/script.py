#!/usr/bin/env python3
"""
n=8, popcount in {3,4} (C(8,3)+C(8,4)=126 masks).

Same DP as n=9 {4,5} sweep: coord + r-sparse XOR r=2..(n-1), unions, full n-XOR.
Threshold slice for majority t=4: wt 3 vs wt 4.
"""
