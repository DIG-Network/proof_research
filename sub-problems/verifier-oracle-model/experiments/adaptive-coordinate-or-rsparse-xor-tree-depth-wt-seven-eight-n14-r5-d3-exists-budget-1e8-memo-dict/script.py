#!/usr/bin/env python3
"""
n=14 {7,8}: r=5, d=3-only with --max-exists-calls 100_000_000 (10^8), --memo-dict.

Parent: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14/script.py

Prior sibling: adaptive-coordinate-or-rsparse-xor-tree-depth-wt-seven-eight-n14-r5-d3-exists-budget-3e7-memo-dict
(INCONCLUSIVE PARTIAL at 3×10^7, memo_dict_size ~12.26M, DP ~112.5 s).
