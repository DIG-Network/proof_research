...
Default min_m=4 (exclude small-mod pairs from 054-056).
"""
...
def main() -> None:
    ...
    p.add_argument("--scan-max", type=int, default=200, help="max M1 and M2 inclusive")
    p.add_argument("--min-m", type=int, default=4, help="minimum M1 and M2")
    args = p.parse_args()
    cap = args.scan_max
    lo = args.min_m
