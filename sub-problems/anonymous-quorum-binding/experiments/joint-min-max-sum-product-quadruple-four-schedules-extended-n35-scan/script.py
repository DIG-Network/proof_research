...
098 only bounded these four to n<=18 with no collision. 099 scanned squares to n=35.
...
def main() -> None:
    ...
    if all_collide:
        print("PASS_all_four_schedules_collide_by_n35", flush=True)
        print("PASS", flush=True)
        return

    print("FAIL_some_schedule_has_no_collision_through_n35", flush=True)
